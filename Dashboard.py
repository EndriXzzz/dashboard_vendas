...
### Para executar, use o comando: streamlit run Dashboard.py
...
if regiao == 'Brasil':
    regiao = ''  # Correção do operador de atribuição
...
fig_receita_mensal = px.line(
    ...
    y='Preço',
    markers=True,
    range_y=(0, receita_mensal['Preço'].max()),  # Correção aqui
    color='Ano',
    line_dash='Ano',
...
fig_receita_categorias.update_layout(yaxis_title='Receita', xaxis_title='Categoria')
